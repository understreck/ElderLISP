...
namespace terp {
    ...
    using Atomic = std::variant<NIL, bool, int, std::string, Builtin, Function>;
    ...
    auto inline lambda(Definitions& defs, ArgList args) -> Element
    {
        ...
        return Atomic{Function{
                [defs,
                 ...
                 body     = std::move(args[1])](ArgList args) -> Element {
